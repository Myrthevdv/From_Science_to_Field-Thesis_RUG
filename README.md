...
-  ```BERT_score_development.ipynb```
    - Contains the code to calculate the BERTScore by hand for the ```Development_set_summaries_and_BERTScores.xlsx```, the results are filled in this dataset by hand.
-  ```BERTscore```
